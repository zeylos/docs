...
import { DOCS_EDITOR_CLASS, useHeadingStore } from '@/features/docs/doc-editor';
...
import { usePanelEditorStore } from './usePanelEditorStore';
      ...
      >
        ...
        >
          <Box
            ...
            $hasTransition="slow"
            $css={`
                border-top: 2px solid ${colorsTokens['brand-600']};
        ...
        {isPanelTableContentOpen && (
          <TableContent selector={`.${DOCS_EDITOR_CLASS}`} />
        )}
